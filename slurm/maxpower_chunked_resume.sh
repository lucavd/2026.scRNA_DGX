#!/bin/bash
#SBATCH --job-name=maxpower_chunked_resume
...
# ============================================================
# RESUME: skip 12M (already passed), continue coarse from 15.4M
# Bug fix: signal 9 (OOM killer) now handled as failure
# ============================================================
...
echo "=================================================================="
echo "CHUNKED MAX-POWER — RESUME from 15.4M (12M already passed)"
echo "=================================================================="
echo "Date: $(date)"
echo "Node: $(hostname)"
...
echo "Resume: coarse search from 15,436,470 (12M = known pass)"
echo ""

# Resume coarse search from 15.4M — skips 12M which already passed
